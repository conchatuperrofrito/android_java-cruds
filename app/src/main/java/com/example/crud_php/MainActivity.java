...
public class MainActivity extends AppCompatActivity {
    ...
    String url = "https://uncounselled-steril.000webhostapp.com/crudSelect.php";
    Usuarios usuarios;
    @Override
    ...
    private void deleteData(final String id) {
        ...
        StringRequest request = new StringRequest(Request.Method.POST, "https://uncounselled-steril.000webhostapp.com/crudEliminar.php",
